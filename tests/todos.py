...
SUITES = ("smoke.py", "test_run.py", "test_votacao.py", "test_combate.py", "test_pontos.py", "test_personagens.py", "test_critico_expertise.py", "test_ajuda_feedback.py", "test_geracao.py")
